...
- 왜 선형이어야 하는가?
  - recursive한 filter equation을 closed form으로 정리하기 위해서는 state가 gaussian 분포를
    유지해야하기 때문이다.
...
- 방식 :
  ...
  1. sigma point를 계산한다.  
   ![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img1.png)
  
2. non-linear system에 통과시켜 sigma point를 transform 한다.  
     ![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img2.png)

  3. transformed & weighted sigma point들로 부터 gaussian parameter($\mu, \sum$)을 계산한다.  
   ![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img3.png)
...
##### __1. eigen value decomposition__[^2]

- $\sum = SS$ -> $\sqrt{\sum}=S$

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img4.png)

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img5.png)
...
__2. Cholesky Matrix Square Root__[^3]
...
__굳이 principle axis에 놓인 sample을 선택 안해도 된다는데 그래도 최적의 결과가 나오는가?__
...
![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img6.png)

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img7.png)

 ![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img8.png)
...
![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img9.png)

### Correction

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img10.png)



### UKF vs EKF

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img11.png)

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img12.png)

![](/images/posts/SLAM/2019-09-20-Unscented-kalman-filter/img13.png)
